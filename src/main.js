...
function getRandomWord(wordList, capitalize = false) {
	...
	if(wordList.length > 0) {
		...
		word = 'ERROR' // not good error handling, but mind your own business
	}
	return word
}
